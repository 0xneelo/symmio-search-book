...
The latest Volume 04 publication batch completes the Percolator/token-margined issue track by publishing Percolator proof-of-concept and source-map boundaries, seven failure-mode synthesis, SOV insurance/deflation modeling, pump bankruptcy arithmetic, shorting death spiral, spot-perp pump-and-dump attack, stable-margin manipulation-cost framing, USDC hybrid and settlement-separation pages, and the five Vibe/Percolator comparison pages. It keeps live Percolator/SOV parameters, insurance/burn mechanics, bankruptcy/manipulation examples, shorting death-spiral claims, USDC settlement guarantees, defense/ADL behavior, oracle/execution policy, LP/solver economics, trustlessness tradeoffs, and legal/risk/security-sensitive advice under primary-source/operator/product/risk/legal/security review. The previous Volume 04 publication batch promoted the Percolator/token-margined risk-foundations cluster; earlier Volume 04 passes completed the USDC-vs-token-margined and Funding Rate Model candidate tracks.

The candidate review queue now includes the remaining `203` candidate pages after the first `595` source/prose/route/current-source/operator-boundary-reviewed pages moved to `published`. Its launch lanes are `0` final-review-ready pages, `203` operator-review pages, `0` source-refresh pages, `0` publication-date-review pages, and `0` editorial-review pages. The product-reference, competitive-context, compendium singleton, Volume 02, Volume 03, Volume 04 Funding Rate Model, Volume 04 USDC-vs-token-margined, and Volume 04 Percolator/token-margined lanes have no remaining candidate pages; protocol-reference candidates are down to `96`, rewards-referrals candidates are down to `84`, manifesto candidates are down to `23`, and the remaining volume lanes are Volume 04 (`11`), Volume 05 (`108`), and Volume 06 (`84`).
