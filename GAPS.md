...
The candidate review queue now includes the remaining `783` candidate pages after the first `15` source/prose/route-reviewed pages moved to `published`. Its launch lanes are `144` final-review-ready pages, `619` operator-review pages, `9` source-refresh pages, `8` publication-date-review pages, and `3` editorial-review pages.
