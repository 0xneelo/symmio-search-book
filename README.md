...
source-backed existing-page triage and public-copy review state,
...
Discord route-coverage counts, source-backed triage counts, public-copy review counts, and
...
the same sanitized summary, including automated triage status and public-copy review status.
