...
- The OpenAI-compatible LLM RAG runtime exists. The latest 2026-07-02 live `gpt-4.1-mini` eval passed 47/47 fixtures: 20/20 adversarial cases (including two answered-with-disclaimer financial-advice cases) and 27/27 answer-validation cases, with 22 measured calls, 132,915 input tokens, 11,443 output tokens, and an estimated cost of $0.02680305.
...
- Live evaluation checkpoint: 2026-07-02, `gpt-4.1-mini`, 47/47 total fixtures passed, 20/20 adversarial and 27/27 answer-validation, 22 measured calls, 132,915 input tokens, 11,443 output tokens, estimated cost $0.02680305.
