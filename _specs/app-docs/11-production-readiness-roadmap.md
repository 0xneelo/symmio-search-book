...
Updated: 2026-07-02 after the financial-advice answered-with-disclaimer policy change, the OpenAI-backed RAG runtime, current live `gpt-4.1-mini` eval refresh, Discord/Lafa ingestion-tooling checkpoint, operator publication decisions, the completed publication-lane checkpoints, requirement-map publication-state alignment, and source-blocker reconciliation.
...
- The OpenAI-compatible LLM RAG runtime exists. The latest 2026-07-02 live `gpt-4.1-mini` eval passed 46/46 fixtures: 19/19 adversarial cases (including two answered-with-disclaimer financial-advice cases) and 27/27 answer-validation cases, with 22 measured calls, 132,915 input tokens, 11,034 output tokens, and an estimated cost of $0.02655765.
...
- Live evaluation checkpoint: 2026-07-02, `gpt-4.1-mini`, 46/46 total fixtures passed, 19/19 adversarial and 27/27 answer-validation, 22 measured calls, 132,915 input tokens, 11,034 output tokens, estimated cost $0.02655765.
