...
- The OpenAI-compatible LLM RAG runtime exists. The latest 2026-07-02 live `gpt-4.1-mini` eval passed 44/44 fixtures: 16/16 adversarial refusals and 28/28 answer-validation cases, with 16 measured calls, 94,657 input tokens, 8,378 output tokens, and an estimated cost of $0.01922535.
...
- Live evaluation checkpoint: 2026-07-02, `gpt-4.1-mini`, 44/44 total fixtures passed, 16/16 adversarial and 28/28 answer-validation, 16 measured calls, 94,657 input tokens, 8,378 output tokens, estimated cost $0.01922535.
