...
- The OpenAI-compatible LLM RAG runtime exists. The latest 2026-07-02 live `gpt-4.1-mini` eval passed 44/44 fixtures: 17/17 adversarial cases (including two answered-with-disclaimer financial-advice cases) and 27/27 answer-validation cases, with 18 measured calls, 106,385 input tokens, 9,485 output tokens, and an estimated cost of $0.02164875.
...
- Live evaluation checkpoint: 2026-07-02, `gpt-4.1-mini`, 44/44 total fixtures passed, 17/17 adversarial and 27/27 answer-validation, 18 measured calls, 106,385 input tokens, 9,485 output tokens, estimated cost $0.02164875.
