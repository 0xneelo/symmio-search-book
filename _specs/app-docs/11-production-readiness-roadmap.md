...
- Keep the production preflight in the verification path so unsafe local defaults, wildcard origins, repo-local DB paths, missing LLM env, and secret-printing regressions fail before launch.
