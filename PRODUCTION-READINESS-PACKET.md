...
- Latest strict manual launch/release evidence: launch run `28607883516` and release run `28607883748` passed from commit `3a64427`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28607883516` and `/tmp/search-book-gh-manual-release-28607883748` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
