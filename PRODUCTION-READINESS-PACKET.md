...
- Latest strict manual launch/release evidence: launch run `28605622743` and release run `28605624182` passed from commit `6c831f6`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28605622743` and `/tmp/search-book-gh-manual-release-28605624182` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
