...
- Local preview evidence: latest local launch drill passed from commit `3058564` against temporary preview `127.0.0.1:44894` plus service `127.0.0.1:45552`, with write-smoke, restore-check, and 15/15 staging launch checks from generatedAt `2026-07-02T22:09:51.457Z`
