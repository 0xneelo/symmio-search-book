...
- Local preview evidence: latest local launch drill passed against temporary preview `127.0.0.1:46448` plus service `127.0.0.1:46108`, with write-smoke, restore-check, and 15/15 staging launch checks from generatedAt `2026-07-02T03:23:21.850Z`
- Latest strict manual launch/release evidence: launch run `28563895736` and release run `28563895301` passed from commit `c1f41a4`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28563895736` and `/tmp/search-book-gh-manual-release-28563895301` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
