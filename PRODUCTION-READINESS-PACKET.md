...
- Local preview evidence: latest local launch drill passed against temporary preview `127.0.0.1:45264` plus service `127.0.0.1:46428`, with write-smoke, restore-check, and 15/15 staging launch checks from generatedAt `2026-07-02T08:13:13.938Z`
- Latest strict manual launch/release evidence: launch run `28575976127` and release run `28575985264` passed from commit `77435eb`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28575976127` and `/tmp/search-book-gh-manual-release-28575985264` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
