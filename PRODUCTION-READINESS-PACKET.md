...
- Local preview evidence: latest local launch drill passed against temporary preview `127.0.0.1:46248` plus service `127.0.0.1:45502`, with write-smoke, restore-check, and 15/15 staging launch checks from generatedAt `2026-07-02T09:17:18.217Z`
- Latest strict manual launch/release evidence: launch run `28577927757` and release run `28577927584` passed from commit `ba02c4b`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28577927757` and `/tmp/search-book-gh-manual-release-28577927584` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
