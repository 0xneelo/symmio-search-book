...
- Latest strict manual launch/release evidence: launch run `28574256285` and release run `28574252904` passed from commit `74dab43`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28574256285` and `/tmp/search-book-gh-manual-release-28574252904` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
