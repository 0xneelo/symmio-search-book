...
- Latest strict manual launch/release evidence: launch run `28612838559` and release run `28612837666` passed from commit `dc3153e`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28612838559` and `/tmp/search-book-gh-manual-release-28612837666` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
