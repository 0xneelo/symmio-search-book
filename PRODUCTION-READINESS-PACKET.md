...
- Latest strict manual launch/release evidence: launch run `28596428188` and release run `28596430894` passed from commit `fab5443`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28596428188` and `/tmp/search-book-gh-manual-release-28596430894` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
