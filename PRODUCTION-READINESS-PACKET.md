...
- Local preview evidence: latest local launch drill passed against temporary preview `127.0.0.1:46368` plus service `127.0.0.1:45066`, with write-smoke, restore-check, and 15/15 staging launch checks from generatedAt `2026-07-02T15:12:25.686Z`
- Latest strict manual launch/release evidence: launch run `28599862451` and release run `28599862002` passed from commit `75ee94e`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28599862451` and `/tmp/search-book-gh-manual-release-28599862002` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
