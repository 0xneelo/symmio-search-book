...
- Latest strict manual launch/release evidence: launch run `28611366514` and release run `28611364709` passed from commit `323e4de`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28611366514` and `/tmp/search-book-gh-manual-release-28611364709` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
