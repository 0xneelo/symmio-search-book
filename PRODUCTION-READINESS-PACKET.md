...
- Latest strict manual launch/release evidence: launch run `28609583940` and release run `28609589661` passed from commit `ddeb94a`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28609583940` and `/tmp/search-book-gh-manual-release-28609589661` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
