...
- Local preview evidence: latest local launch drill passed against temporary preview `127.0.0.1:46236` plus service `127.0.0.1:44822`, with write-smoke, restore-check, and 15/15 staging launch checks from generatedAt `2026-07-02T07:42:33.668Z`
- Latest strict manual launch/release evidence: launch run `28572885083` and release run `28572886291` passed from commit `a55c190`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28572885083` and `/tmp/search-book-gh-manual-release-28572886291` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
