...
- Local preview evidence: latest local launch drill passed against temporary preview `127.0.0.1:46028` plus service `127.0.0.1:45050`, with write-smoke, restore-check, and 15/15 staging launch checks from generatedAt `2026-07-02T15:33:02.701Z`
- Latest strict manual launch/release evidence: launch run `28602590754` and release run `28602592251` passed from commit `a3153f3`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28602590754` and `/tmp/search-book-gh-manual-release-28602592251` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
