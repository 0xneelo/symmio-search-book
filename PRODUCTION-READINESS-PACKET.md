...
- Latest strict manual launch/release evidence: launch run `28589129207` and release run `28589128842` passed from commit `3d69991`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28589129207` and `/tmp/search-book-gh-manual-release-28589128842` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
