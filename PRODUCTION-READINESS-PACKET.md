...
- Latest strict manual launch/release evidence: launch run `28601334154` and release run `28601332272` passed from commit `03ce5d1`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28601334154` and `/tmp/search-book-gh-manual-release-28601332272` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
