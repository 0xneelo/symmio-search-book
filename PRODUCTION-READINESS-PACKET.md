...
- Latest strict manual launch/release evidence: launch run `28566355604` and release run `28566356824` passed from commit `1c6589d`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28566355604` and `/tmp/search-book-gh-manual-release-28566356824` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
