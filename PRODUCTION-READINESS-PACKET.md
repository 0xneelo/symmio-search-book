...
- Latest strict manual launch/release evidence: launch run `28562722103` and release run `28562721857` passed from commit `127c280`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28562722103` and `/tmp/search-book-gh-manual-release-28562721857` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
