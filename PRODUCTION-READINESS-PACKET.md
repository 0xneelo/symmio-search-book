...
- Latest strict manual launch/release evidence: launch run `28579589439` and release run `28579589836` passed from commit `95a693a`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28579589439` and `/tmp/search-book-gh-manual-release-28579589836` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
