...
- Latest strict manual launch/release evidence: launch run `28569707536` and release run `28569707443` passed from commit `2f6c5de`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28569707536` and `/tmp/search-book-gh-manual-release-28569707443` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
