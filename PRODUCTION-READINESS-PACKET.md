...
- Local preview evidence: latest local launch drill passed from commit `714cae0` against temporary preview `127.0.0.1:46052` plus service `127.0.0.1:44744`, with write-smoke, restore-check, and 15/15 staging launch checks from generatedAt `2026-07-02T21:11:07.925Z`
