...
- Latest strict manual launch/release evidence: launch run `28556232756` and release run `28556232873` passed from commit `23099dc`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28556232756` and `/tmp/search-book-gh-manual-release-28556232873` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
