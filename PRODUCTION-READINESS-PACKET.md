...
- Latest strict manual launch/release evidence: launch run `28553748808` and release run `28553757442` passed from commit `da114dc`; downloaded artifacts under `/tmp/search-book-gh-manual-launch-28553748808` and `/tmp/search-book-gh-manual-release-28553757442` passed strict summary validation without printing secrets, and check-run annotations were empty (`[]`)
