---
id: "section-02-proof-of-value-02-docs-05-intent-based-architecture-5-2-no-liquidity-pools-needed"
title: "Section 5: Intent-Based Architecture: 5.2 No Liquidity Pools Needed"
...
sourceUrls: ["https://0xneelo.github.io/vibe_docs/docs/02-proof-of-value/02-docs/05-intent-based-architecture#5-2-no-liquidity-pools-needed"]
...
headingId: "5-2-no-liquidity-pools-needed"
---

# Section 5: Intent-Based Architecture: 5.2 No Liquidity Pools Needed

> Draft status: extracted from a primary Neelo source heading. Needs editorial restructuring, cross-links, and source-note polish before final publication.

## Sources
- https://0xneelo.github.io/vibe_docs/docs/02-proof-of-value/02-docs/05-intent-based-architecture#5-2-no-liquidity-pools-needed
