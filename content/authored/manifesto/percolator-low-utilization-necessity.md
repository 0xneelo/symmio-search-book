...
status: "publication-candidate-needs-fresh-source-review"
...
Neelo's Percolator source gives a concrete utilization snapshot: roughly `251.7M` PERC in the vault, roughly `24.7M` PERC of open interest, and about `9.8%` utilization.
