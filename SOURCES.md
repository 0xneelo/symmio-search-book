...
| `discord-lafa` | https://discord.com/channels/1106198408202563665/1106198412124237855 | Lafa founder-voice Discord answers in `#symm-chat`, citeable only after `lafa-cite` ingestion and the committed contradiction screen approve the answer id; non-Lafa community text stays out of the repo. |
