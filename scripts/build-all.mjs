...
function runInvariants() {
  ...
  assert(living.retentionPolicyImplemented && living.moderationExportImplemented && !living.livingDocsProductionReady, "living-docs production boundary is unexpected");
