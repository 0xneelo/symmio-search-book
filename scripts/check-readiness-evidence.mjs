...
const docs = [
  { id: "final-report", relativePath: "docs/FINAL-REPORT.md" },
  { id: "progress", relativePath: "docs/PROGRESS.md" },
  { id: "roadmap", relativePath: "_specs/app-docs/11-production-readiness-roadmap.md" },
  { id: "llm-rag-contract", relativePath: "docs/LLM-RAG-CONTRACT.md" },
];
...
const staleMarkers = [
  ...
  { label: "previous SYN-215 output token total", value: "8,067" },
  { label: "previous SYN-215 output token total", value: "8067" },
  { label: "previous SYN-215 cost", value: "$0.01732860" },
  { label: "previous SYN-215 cost", value: "0.0173286" },
  { label: "previous SYN-215 output token total", value: "7,566" },
  { label: "previous SYN-215 output token total", value: "7566" },
  { label: "previous SYN-215 cost", value: "$0.01702800" },
  { label: "previous SYN-215 cost", value: "0.017028" },
  { label: "previous SYN-215 output token total", value: "7,930" },
  ...
  { label: "previous SYN-215 output token total", value: "7,379" },
  { label: "previous SYN-215 output token total", value: "7379" },
  { label: "previous SYN-215 cost", value: "$0.01762890" },
  { label: "previous SYN-215 cost", value: "0.0176289" },
];
