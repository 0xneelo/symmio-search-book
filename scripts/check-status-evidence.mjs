...
function expectedChecks(evidence) {
  ...
  return {
    "FINAL-REPORT.md": [
      ...
      { id: "clean-release-evidence", allOf: ["search-book-release-dry-run-clean-repo", "repository dirty state `false`", "same commit", "original-spec reconciliation evidence", "evidence summary renderer status `passed`", "publication boundaries status `passed`"] },
    ...
    "COMPLETION-AUDIT.md": [
      ...
      { id: "clean-release-evidence", allOf: ["search-book-release-dry-run-clean-repo", "repository dirty state `false`", "same commit", "original-spec reconciliation evidence", "evidence summary renderer evidence `passed`", "publication-boundary evidence `passed`"] },
