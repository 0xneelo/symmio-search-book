...
const authoredVolumeOverrides = {
  ...
  "authored-exploit-resistance-pillar": "volume-04-token-margin-and-funding-systems",
  ...
  "authored-bootstrap-counterparty-pillar": "volume-04-token-margin-and-funding-systems",
  "authored-coupled-design-problem": "volume-04-token-margin-and-funding-systems",
  "authored-funding-defense-hierarchy": "volume-04-token-margin-and-funding-systems",
  "authored-lp-yield-capital-efficiency-pillar": "volume-04-token-margin-and-funding-systems",
...
function parseArgs(argv) {
  ...
  for (let index = 0; index < argv.length; index += 1) {
    ...
    if (arg === "--out-json") args.outJson = argv[++index];
      ...
      console.log("Usage: node scripts/build-volume-map.mjs [--out-json path] [--out-js path]");
      process.exit(0);
    } else {
