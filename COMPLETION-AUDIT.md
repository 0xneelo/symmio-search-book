...
- `data/question-routes.json`: 809 exact routes.
- `data/faq.json`: 811 FAQ entries.
...
| Build answer-engine front door with exact page routing and citations | Satisfied locally | 809/809 exact routes, 32/32 glossary routes, 2/2 refusal routes, 2,884 chunks; local preview/service and staging launch drill passed; live LLM eval passed 42/42. | Production model-backed service still depends on #11 and deploy route #4. |
