...
The Search Book now has a 500-800 page compendium shape with 794 manifest pages, 799 authored pages, 8 volumes, 104 chapters, and 1,593 reader-routable pages assigned to volumes. The first 94 authored pages are marked `published`; the remaining authored pages stay in candidate/review states. The generated corpus stays inside the requested 500-800 page target while the reader layer includes authored pages plus source companions for traceability.

The authored layer now covers every generated source companion: `data/publication-plan.*` reports 792 source companions queued, 792 covered by authored pages, 0 needing authored coverage, and 704 candidate pages still in the review queue. The remaining candidate review lanes are 65 final-review-ready pages, 619 operator-review pages, 9 source-refresh pages, 8 publication-date-review pages, and 3 editorial-review pages. Source companions remain retrieval and traceability material, not public navigation pages.
...
| Authored layer | 799 authored pages across manifesto, product, rewards, dashboard, protocol, answer-engine, glossary, and compendium sections; 94 published pages; 792/792 source companions covered by authored pages; 65 candidate pages ready for final review before the operator/source/editorial lanes | Partially published; most pages still need final source/deploy review |
