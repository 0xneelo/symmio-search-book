...
| Living docs | 12/12 event fixtures, SQLite service, frontend bridge, retention policy, helpful answer-cache reuse, dynamic examples endpoint, gated moderation export, internal reviewer summary job | Implemented locally; production deployment/admin operations still parked |
