...
| Authored layer | 799 authored pages across manifesto, product, rewards, dashboard, protocol, answer-engine, glossary, and compendium sections; 711 published pages; 87 candidate pages; 792/792 source companions covered by authored pages; 0 candidate pages ready for final review before the operator-review lane | Partially published; remaining pages still need operator/source/deploy review |
...
- OPERATOR-INBOX #16: Linear comment approval timed out for the latest production-readiness handoff. This does not block corpus/runtime work, but it blocks completing that handoff's Linear-linked artifact until a refreshed comment path is available.
